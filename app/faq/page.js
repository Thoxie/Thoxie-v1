  ...
  return (
    <main style={pageWrapStyle}>
      ...
      <Container style={contentWrapStyle}>
        ...
        <p style={leadStyle}>
          Clear answers to common questions about how Small Claims Genie helps you prepare a small claims case. If you don’t see your
          question here, describe what happened in plain English and Small Claims Genie will guide you.
        </p>

        <section style={faqListStyle} aria-label="FAQ">
          <article style={cardStyle}>
            <h3 style={qStyle}>How does Small Claims Genie help people file small claims cases?</h3>
            <p style={aStyle}>
              Small Claims Genie turns the small-claims process into a guided workflow. You answer structured questions, and Small Claims Genie
          ...
          <article style={cardStyle}>
            <h3 style={qStyle}>Do I need a lawyer to use Small Claims Genie?</h3>
            <p style={aStyle}>
              No. Small claims court is designed so people can represent themselves. Small Claims Genie is built to guide you through
          ...
          <article style={cardStyle}>
            <h3 style={qStyle}>Can Small Claims Genie help me understand whether I have a strong case?</h3>
            <p style={aStyle}>
              Small Claims Genie can help analyze the facts you provide and highlight missing information or evidence that may
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              emails, photos, repair estimates, invoices, and payment records. Small Claims Genie helps you organize these materials
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              Small Claims Genie’s platform fee is separate from court fees and service costs, which are set by the local
              jurisdiction. In general: Small Claims Genie fee + court filing fee + service cost.
            </p>
          </article>
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              awarded if you win. Small Claims Genie helps you track these costs so they can be included properly when preparing
              your claim.
            </p>
          </article>
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              Small-claims limits are set by each state (and sometimes by court type). Small Claims Genie helps you stay within the
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              injury, etc.). Small Claims Genie helps you identify deadlines by asking what happened and when it happened.
            </p>
          </article>
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              the dispute happened. Small Claims Genie helps you identify the correct court by collecting those key facts and using
              them to direct the filing to the proper place.
            </p>
          </article>

          <article style={cardStyle}>
            <h3 style={qStyle}>Can I file a case against a business using Small Claims Genie?</h3>
            <p style={aStyle}>
              Yes. Small claims courts commonly allow cases against businesses (contractors, landlords, retailers, and
              service providers). Small Claims Genie helps you capture the business details, what happened, and what you’re asking
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              this step. Small Claims Genie can help generate a professional demand letter that’s structured, clear, and easy to
              support with receipts, messages, and timelines.
            </p>
          </article>

          <article style={cardStyle}>
            <h3 style={qStyle}>Does Small Claims Genie handle service of process?</h3>
            <p style={aStyle}>
              Every small-claims case requires formal notice to the defendant (service of process). Small Claims Genie guides you
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              agree to a payment or resolution, the case can often be closed without appearing in court. Small Claims Genie helps
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              Small Claims Genie helps you organize your presentation so the facts are clear and easy to follow.
            </p>
          </article>
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              schedule hearings several weeks to a few months later. Small Claims Genie helps you prepare everything in advance so
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              court will usually hear both claims at the same hearing. Small Claims Genie helps you organize your response so you
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              better address, a different service location, or additional steps to locate the defendant. Small Claims Genie helps
          ...
          <article style={cardStyle}>
            ...
            <p style={aStyle}>
              ...
              be options to appeal or take other legal steps depending on local rules. Small Claims Genie helps you prepare a clear,
              well-supported case from the start to improve your chances.
            </p>
          </article>

          <article style={cardStyle}>
            <h3 style={qStyle}>Is my information secure when using Small Claims Genie?</h3>
            <p style={aStyle}>
              Small Claims Genie is designed to handle sensitive information responsibly. The platform stores case details securely
              and uses them only to help prepare your claim and related documents.
            </p>
          </article>

          <article style={cardStyle}>
            <h3 style={qStyle}>Why use Small Claims Genie instead of filing on your own?</h3>
            <p style={aStyle}>
              You can file on your own, but it often requires finding the correct forms, understanding court rules,
              organizing evidence, and completing service properly. Small Claims Genie streamlines this into a guided system so you
